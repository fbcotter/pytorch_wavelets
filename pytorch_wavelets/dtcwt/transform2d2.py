...
from pytorch_wavelets.dtcwt.lowlevel3 import FWD_J1, FWD_J2PLUS, get_dimensions
from pytorch_wavelets.dtcwt.lowlevel3 import INV_J1, INV_J2PLUS
...
class DTCWTForward(nn.Module):
    ...
    def forward(self, x):
        ...
        for j in range(1, self.J):
            ...
            if c % 4 != 0:
                x = torch.cat((low[:,:,:,0:1], low, low[:,:,:,-1:]), dim=3)
